...
class materyal extends State<ogm> {
  ...
  Widget build(BuildContext context) => Scaffold(
      ...
      body: WebView(
        ...
        initialUrl:
            'https://ogmmateryal.eba.gov.tr/soru-bankasi-kazanim/tde?s=6&d=58&u=0&k=0',
...
class klk extends State<kolik> {
  ...
  Widget build(BuildContext context) => Scaffold(
      ...
      body: WebView(
        javascriptMode: JavascriptMode.unrestricted,
        initialUrl: 'https://www.testkolik.com/9-sinif/9-sinif-turk-dili-ve-edebiyati',
        onWebViewCreated: (controller) {
          this.controller = controller;
        },
      ));
...
class cin extends State<testC> {
  ...
  Widget build(BuildContext context) => Scaffold(
      ...
      body: WebView(
        javascriptMode: JavascriptMode.unrestricted,
        initialUrl:
            'https://www.testcin.com/coz/9-sinif-testleri-coz/9-sinif-turk-edebiyati-testleri-coz/',
        onWebViewCreated: (controller) {
          this.controller = controller;
        },
      ));
...
class soru extends State<superr> {
  ...
  Widget build(BuildContext context) => Scaffold(
      ...
      body: WebView(
        javascriptMode: JavascriptMode.unrestricted,
        initialUrl:
            'https://www.supersoru.com/9.sinif-turk-dili-ve-edebiyati-dersi-testlerini-coz',
        onWebViewCreated: (controller) {
          this.controller = controller;
        },
      ));
...
class bul extends State<testleri> {
  ...
  Widget build(BuildContext context) => Scaffold(
      ...
      body: WebView(
        javascriptMode: JavascriptMode.unrestricted,
        initialUrl:
            'https://www.testleribul.com/testleri-coz/9-sinif-turk-dili-ve-edebiyati-testleri/',
        onWebViewCreated: (controller) {
          this.controller = controller;
        },
      ));
...
class dunya extends State<bi> {
  ...
  Widget build(BuildContext context) => Scaffold(
      ...
      body: WebView(
        javascriptMode: JavascriptMode.unrestricted,
        initialUrl: 'https://bidunyatest.com/edebiyat-testleri/9-sinif-edebiyat-testleri',
        onWebViewCreated: (controller) {
          this.controller = controller;
        },
      ));
