...
import 'package:teknodef/dokuzuncusinif/dokuz_dersleri/turkce/web_test/turkce.dart';
class alternatif_turkce extends StatelessWidget {
  @override
  Widget build(BuildContext context) => Scaffold(
      appBar: AppBar(
        title: Text("Türk Dili ve Edebiyatı Test Siteleri",
            style: TextStyle(
