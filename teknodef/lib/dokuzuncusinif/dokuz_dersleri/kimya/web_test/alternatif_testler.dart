...
import 'package:teknodef/dokuzuncusinif/dokuz_dersleri/kimya/web_test/kimya.dart';
class alternatif_kimya extends StatelessWidget {
  @override
  Widget build(BuildContext context) => Scaffold(
      appBar: AppBar(
        title: Text("Kimya Test Siteleri",
            style: TextStyle(
