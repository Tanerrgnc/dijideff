...
import 'package:teknodef/dokuzuncusinif/dokuz_dersleri/tarih/web_test/tarih.dart';
class alternatif_tarih extends StatelessWidget {
  @override
  Widget build(BuildContext context) => Scaffold(
      appBar: AppBar(
        title: Text("Tarih Test Siteleri",
            style: TextStyle(
