...
class klk extends State<kolik> {
  ...
  Widget build(BuildContext context) => Scaffold(
      ...
      body: WebView(
        javascriptMode: JavascriptMode.unrestricted,
        initialUrl: 'https://www.testkolik.com/9-sinif/9-sinif-matematik',
        onWebViewCreated: (controller) {
          this.controller = controller;
        },
      ));
...
class cin extends State<testC> {
  ...
  Widget build(BuildContext context) => Scaffold(
      ...
      body: WebView(
        javascriptMode: JavascriptMode.unrestricted,
        initialUrl:
            'https://www.testcin.com/coz/9-sinif-testleri-coz/9-sinif-matematik-testleri-coz/',
        onWebViewCreated: (controller) {
          this.controller = controller;
        },
      ));
...
class soru extends State<superr> {
  ...
  Widget build(BuildContext context) => Scaffold(
      ...
      body: WebView(
        javascriptMode: JavascriptMode.unrestricted,
        initialUrl:
            'https://www.supersoru.com/9.sinif-matematik-dersi-testlerini-coz',
        onWebViewCreated: (controller) {
          this.controller = controller;
        },
      ));
...
class bul extends State<testleri> {
  ...
  Widget build(BuildContext context) => Scaffold(
      ...
      body: WebView(
        javascriptMode: JavascriptMode.unrestricted,
        initialUrl:
            'https://www.testleribul.com/testleri-coz/9-sinif-matematik-testleri/',
        onWebViewCreated: (controller) {
          this.controller = controller;
        },
      ));
...
class dunya extends State<bi> {
  ...
  Widget build(BuildContext context) => Scaffold(
      ...
      body: WebView(
        javascriptMode: JavascriptMode.unrestricted,
        initialUrl:
            'https://bidunyatest.com/matematik-testleri/9-sinif-matematik-testleri',
        onWebViewCreated: (controller) {
          this.controller = controller;
        },
      ));
