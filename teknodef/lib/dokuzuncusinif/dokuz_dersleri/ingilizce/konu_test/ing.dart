...
import 'package:teknodef/dokuzuncusinif/dokuz_dersleri/ingilizce/web_test/alternatif_testler.dart';
import 'package:teknodef/main.dart';
import '../uniteler/ing.dart';

class D_ingilizce_KTD extends StatelessWidget {
  @override
      ...
      body: Column(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: <
        ...
        Center(
          child: RaisedButton(
            ...
            onPressed: () => Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => D_ing_K()),
            ),
            child: Container(
        ...
        Center(
          child: RaisedButton(
            ...
            onPressed: () => Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => alternatif_ingilizce()),
            ),
            child: Container(
              padding:
