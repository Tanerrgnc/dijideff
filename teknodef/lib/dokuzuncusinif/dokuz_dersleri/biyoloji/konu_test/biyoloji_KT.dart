...
import '../web_test/alternatif_testler.dart';

class D_biyoloji_KTD extends StatelessWidget {
  @override
      ...
      body: Column(
        ...
        Center(
          child: RaisedButton(
            ...
            onPressed: () => Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => D_biyoloji_K()),
            ),
            child: Container(
        ...
        Center(
          child: RaisedButton(
            ...
            onPressed: () => Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => alternatif_biyoloji()),
            ),
            child: Container(
              padding:
