...
import 'package:teknodef/dokuzuncusinif/dokuz_dersleri/biyoloji/web_test/biyoloji.dart';

class alternatif_biyoloji extends StatelessWidget {
  @override
  Widget build(BuildContext context) => Scaffold(
      appBar: AppBar(
        title: Text("Biyoloji Test Siteleri",
            style: TextStyle(
