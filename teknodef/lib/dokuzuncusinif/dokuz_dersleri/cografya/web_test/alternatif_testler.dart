...
import 'package:teknodef/dokuzuncusinif/dokuz_dersleri/cografya/web_test/cografya.dart';
class alternatif_cografya extends StatelessWidget {
  @override
  Widget build(BuildContext context) => Scaffold(
      appBar: AppBar(
        title: Text("Coğrafya Test Siteleri",
            style: TextStyle(
