...
import 'package:teknodef/onuncusinif/on_dersleri/din/web_test/din.dart';
class din_test_ekrani extends StatelessWidget {
  @override
  Widget build(BuildContext context) => Scaffold(
      appBar: AppBar(
        title: Text("Din Kültürü Test Siteleri",
            style: TextStyle(
        ...
        child: Container(
            ...
            child: Column(
                ...
                children: <Widget>[
                  ...
                  Center(
                    child: Container(
                      margin: EdgeInsets.only(top: 30, bottom: 80.5),
                      child: RaisedButton(
                        shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(50)),
                        onPressed: () => Navigator.push(
