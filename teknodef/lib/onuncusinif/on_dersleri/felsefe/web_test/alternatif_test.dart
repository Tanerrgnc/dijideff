...
import 'package:teknodef/onuncusinif/on_dersleri/felsefe/web_test/felsefe.dart';
class felsefe_test_ekrani extends StatelessWidget {
  @override
  Widget build(BuildContext context) => Scaffold(
      appBar: AppBar(
        title: Text("Felsefe Test Siteleri",
            style: TextStyle(
