...
class klk extends State<kolik> {
  ...
  Widget build(BuildContext context) => Scaffold(
      ...
      body: WebView(
        javascriptMode: JavascriptMode.unrestricted,
        initialUrl: 'https://www.testkolik.com/10-sinif/10-sinif-matematik',
        onWebViewCreated: (controller) {
          this.controller = controller;
        },
      ));
...
class cin extends State<testC> {
  ...
  Widget build(BuildContext context) => Scaffold(
      ...
      body: WebView(
        javascriptMode: JavascriptMode.unrestricted,
        initialUrl:
            'https://www.testcin.com/coz/10-sinif-testleri-coz/10-sinif-matematik-testleri-coz/',
        onWebViewCreated: (controller) {
          this.controller = controller;
        },
      ));
...
class soru extends State<superr> {
  ...
  Widget build(BuildContext context) => Scaffold(
      ...
      body: WebView(
        javascriptMode: JavascriptMode.unrestricted,
        initialUrl:
            'https://www.supersoru.com/10.sinif-matematik-dersi-testlerini-coz',
        onWebViewCreated: (controller) {
          this.controller = controller;
        },
      ));
...
class bul extends State<testleri> {
  ...
  Widget build(BuildContext context) => Scaffold(
      ...
      body: WebView(
        javascriptMode: JavascriptMode.unrestricted,
        initialUrl:
            'https://www.testleribul.com/testleri-coz/10-sinif-matematik/',
        onWebViewCreated: (controller) {
          this.controller = controller;
        },
      ));
...
class dunya extends State<bi> {
  ...
  Widget build(BuildContext context) => Scaffold(
      ...
      body: WebView(
        javascriptMode: JavascriptMode.unrestricted,
        initialUrl:
            'https://bidunyatest.com/matematik-testleri/10-sinif-matematik-testleri',
        onWebViewCreated: (controller) {
          this.controller = controller;
        },
      ));
