...
import 'package:teknodef/onuncusinif/on_dersleri/matematik/web_test/mat.dart';
class Matematik_test_ekrani extends StatelessWidget {
  @override
  Widget build(BuildContext context) => Scaffold(
      appBar: AppBar(
        title: Text("Matematik Test Siteleri",
            style: TextStyle(
