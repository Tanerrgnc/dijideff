...
import 'package:teknodef/onuncusinif/on_dersleri/kimya/kimya_konu_anlatimi.dart';
import 'package:teknodef/onuncusinif/on_dersleri/kimya/web_test/alternatif_test.dart';
class O_kimya_KT extends StatelessWidget {
  @override
      ...
      body: Column(
        ...
        Center(
          child: RaisedButton(
            ...
            onPressed: () => Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => Kimya_test_ekrani()),
            ),
            child: Container(
              padding:
