...
import 'package:teknodef/onuncusinif/on_dersleri/ingilizce/web_test/ingilizce.dart';

class ingilizce_test_ekrani extends StatelessWidget {
  @override
  Widget build(BuildContext context) => Scaffold(
      appBar: AppBar(
        title: Text("İngilizce Test Siteleri",
            style: TextStyle(
        ...
        child: Container(
            ...
            child: Column(
                ...
                children: <Widget>[
                  ...
                  Center(
                    child: Container(
                      margin: EdgeInsets.only(top: 30, bottom: 320),
                      child: RaisedButton(
                        shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(50)),
                        onPressed: () => Navigator.push(
