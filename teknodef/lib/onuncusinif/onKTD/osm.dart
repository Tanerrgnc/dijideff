...
import 'package:teknodef/onuncusinif/onT/osm.dart';
class O_osmanlica_KTD extends StatelessWidget{
  @override
  Widget build(BuildContext context) => Scaffold(
        appBar: AppBar(
          title: Text("Osmanlıca",
              style: TextStyle(
          ...
          Center(
            child: Container(
              ...
              child: RaisedButton(
                onPressed: () => Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => O_osmanlica_T()),
                ),
                child: Container(
                  padding:
